...
class Config:
    ...
    def get_default_system_prompt() -> str:
        """Get a minimal default system prompt for hierarchical strategic planning"""
        return """You are a strategic planner that thinks hierarchically. You break down complex objectives into clear, actionable plans with well-defined dependencies and outcomes.

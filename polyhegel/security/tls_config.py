...
class CertificateManager:
    ...
    def generate_ca_certificate(self) -> tuple[str, str]:
        ...
        cert = (
            ...
            .not_valid_after(datetime.datetime.utcnow() + datetime.timedelta(days=self.config.cert_validity_days))
            .add_extension(
    ...
    def generate_agent_certificate(
        self, agent_name: str, ca_cert_path: str, ca_key_path: str, hostnames: list[str] = None
    ) -> tuple[str, str]:
    ...
    def setup_agent_certificates(self) -> Dict[str, tuple[str, str]]:
        ...
        agents = [
            "polyhegel-leader",
            "polyhegel-follower-resource",
            "polyhegel-follower-security",
            "polyhegel-follower-value",
            "polyhegel-follower-general",
            "polyhegel-simulation",
        ]

        certificates = {}
        for agent in agents:
            cert_path, key_path = self.generate_agent_certificate(agent, ca_cert_path, ca_key_path)

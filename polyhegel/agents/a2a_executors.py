...
from ..telemetry import (
    get_telemetry_collector, EventType, time_operation, timed_operation
)
...
class LeaderAgentExecutor(AgentExecutor):
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        self._telemetry_collector.record_event(
            ...
            data={"operation": "theme_generation", "task_id": context.task_id}
        )
        ...
        try:
            ...
            if not user_input.strip():
                self._telemetry_collector.record_event(
                    ...
                    data={"error": "No strategic challenge provided"},
                    success=False
                )
...
class FollowerAgentExecutor(AgentExecutor):
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        try:
            ...
            # Update error metrics
            self._telemetry_collector.increment_counter(
                "strategy_development_errors_total",
                tags={"error_type": type(e).__name__}
            )

...
from polyhegel.prompts import get_system_prompt, get_template, load_prompt
...
class TestPromptLoader:
        ...
        config = {
            "prompts": {
                "strategic": {
                    "evaluator": {
                        "file": "strategic/evaluate.md",
                        "description": "Strategic evaluator prompt"
                    }
                },
                "general": {
                    "default": {
                        "file": "general/default.md", 
    ...
    def test_validate_template_parameters(self):
        ...
        # Valid parameters
        assert self.loader.validate_template_parameters(
            "test_template", 
            {"param1": "value1", "param2": "value2"}
        )
        
        # Missing parameters
        assert not self.loader.validate_template_parameters(
            "test_template",
            {"param1": "value1"}
        )

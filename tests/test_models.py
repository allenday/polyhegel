...
from polyhegel.models import StrategyStep, GenesisStrategy, StrategicTheme, ThemeCategory, StrategyChain
...
class TestStrategyStep:
    ...
    def test_strategy_step_defaults(self):
        ...
        step = StrategyStep(action="Test action", prerequisites=[], outcome="Expected outcome", risks=[])
...
class TestGenesisStrategy:
    ...
    def test_genesis_strategy_creation(self):
        ...
        steps = [
            StrategyStep(action="Step 1", prerequisites=["Prereq 1"], outcome="Outcome 1", risks=["Risk 1"]),
            StrategyStep(action="Step 2", prerequisites=["Prereq 2"], outcome="Outcome 2", risks=["Risk 2"]),
        ]
...
class TestStrategicTheme:
    ...
    def test_strategic_theme_creation(self):
        ...
        theme = StrategicTheme(
            ...
            potential_risks=["Stakeholder coordination challenges", "Platform adoption resistance"],
...
class TestStrategyChain:
    ...
    def test_strategy_chain_creation(self):
        ...
        strategy = GenesisStrategy(
            title="Test Strategy",
            steps=[StrategyStep(action="Test Action", prerequisites=["Prereq"], outcome="Outcome", risks=["Risk"])],

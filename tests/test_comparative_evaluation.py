...
class TestMetricsCollector:
    ...
    def _create_sample_strategy(self) -> StrategyChain:
        ...
        strategy = GenesisStrategy(
            ...
            alignment_score={"Strategic Coherence": 4.2, "Implementation Feasibility": 3.8, "Risk Management": 4.0},
    ...
    def test_collect_metrics_basic(self):
        ...
        metrics = self.collector.collect_metrics(simulation_results, execution_time=45.0, memory_usage=128.5)
    ...
    def test_strategy_diversity_calculation(self):
        ...
        different_chain = StrategyChain(strategy=different_strategy, source_sample=2, temperature=0.9)
...
class TestComparativeTestFramework:
    ...
    def setup_method(self):
        """Set up test environment"""
        self.test_config = TestConfiguration(test_name="test_comparison", iterations=2, timeout_seconds=60)
    ...
    async def test_single_test_mock(self):
        ...
        mock_simulator.run_simulation = AsyncMock(
            return_value={
    ...
    def _create_mock_strategy(self):
        ...
        return StrategyChain(strategy=strategy, source_sample=0, temperature=0.8)
    ...
    async def test_comparative_test_mock(self):
        ...
        with patch("polyhegel.evaluation.comparative_test.PolyhegelSimulator", return_value=mock_simulator):
            result = await self.framework.run_comparative_test(system_prompt="Test system", user_prompt="Test user")
    ...
    def test_statistical_analysis(self):
        ...
        clustering_metrics = [
            StrategicMetrics(
                coherence_score=8.0, feasibility_score=7.5, execution_time=30.0, selection_method="clustering"
            ),
            StrategicMetrics(
                coherence_score=7.8, feasibility_score=7.8, execution_time=32.0, selection_method="clustering"
            ),
        ]

        tournament_metrics = [
            StrategicMetrics(
                coherence_score=8.2, feasibility_score=8.0, execution_time=45.0, selection_method="tournament"
            ),
            StrategicMetrics(
                coherence_score=8.1, feasibility_score=7.9, execution_time=43.0, selection_method="tournament"
            ),
        ]

        analysis = self.framework._perform_statistical_analysis(clustering_metrics, tournament_metrics)
    ...
    async def test_save_results(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = ComparisonResult(
                clustering_metrics=[StrategicMetrics(coherence_score=8.0, selection_method="clustering")],
                tournament_metrics=[StrategicMetrics(coherence_score=8.2, selection_method="tournament")],
    ...
    def test_automated_test_suite_config(self):
        ...
        test_scenarios = [
            {"name": "scenario_1", "iterations": 2, "system_prompt": "Test system 1", "user_prompt": "Test user 1"},
            {"name": "scenario_2", "iterations": 1, "system_prompt": "Test system 2", "user_prompt": "Test user 2"},
        ]
...
class TestIntegration:
    ...
    async def test_end_to_end_mock_workflow(self):
        ...
        config = TestConfiguration(test_name="integration_test", iterations=1, timeout_seconds=30)
        ...
        mock_chain = StrategyChain(strategy=mock_strategy, source_sample=0, temperature=0.8)

#!/bin/bash
"""
Start Polyhegel Technical Architecture Follower Agent (Infrastructure Architecture Specialization)

Environment Variables:
  POLYHEGEL_TECHARCH_FOLLOWER_HOST=0.0.0.0
  POLYHEGEL_TECHARCH_FOLLOWER_PORT=9004
  POLYHEGEL_TECHARCH_FOLLOWER_MODEL=claude-3-haiku-20240307
"""

set -e

# Infrastructure architecture specialization
export POLYHEGEL_TECHARCH_FOLLOWER_HOST=${POLYHEGEL_TECHARCH_FOLLOWER_HOST:-"0.0.0.0"}
export POLYHEGEL_TECHARCH_FOLLOWER_PORT=${POLYHEGEL_TECHARCH_FOLLOWER_PORT:-"9004"}
export POLYHEGEL_TECHARCH_FOLLOWER_MODEL=${POLYHEGEL_TECHARCH_FOLLOWER_MODEL:-"claude-3-haiku-20240307"}
export POLYHEGEL_TECHARCH_SPECIALIZATION_DOMAIN="infrastructure_architecture"

echo "Starting Polyhegel Technical Architecture Follower Agent (Infrastructure Architecture)..."
